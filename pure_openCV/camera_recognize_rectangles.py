...
#color ranges
color_ranges = {
	'green': [([40, 80, 100], [80, 255, 255])],
	'red': [([0, 100, 150], [10, 255, 255]), ([170, 150, 150], [179, 255, 255])],
	'blue': [([100, 80, 150], [130, 255, 255])],
	'yellow': [([17, 50, 120], [28, 255, 255])]
}
	...
	for color_name, hsv_ranges in color_ranges.items():
		...
		if contours:
			...
			if M["m00"] != 0:
				...
				cv2.putText(frame, f"{color_name} ({cX}, {cY})", (cX+15, cY),
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)

				# Put the color name and coordinates text
				cv2.putText(frame, f"{color_name} ({cX}, {cY})", (x_text+15, y_text+15),
				cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 2)
